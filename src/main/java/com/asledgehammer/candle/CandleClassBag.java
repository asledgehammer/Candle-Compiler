...
import zombie.entity.*;
import zombie.entity.components.attributes.*;
import zombie.entity.components.build.BuildLogic;
import zombie.entity.components.crafting.*;
import zombie.entity.components.crafting.recipe.*;
import zombie.entity.components.fluids.*;
import zombie.entity.components.lua.LuaComponent;
import zombie.entity.components.parts.Parts;
import zombie.entity.components.resources.*;
...
public class CandleClassBag {
  ...
  private void addClasses__42_00() {
    ...
    addClass(MusicIntensityConfig.class);
    addClass(MusicIntensityEvent.class);
    addClass(MusicIntensityEvents.class);
    addClass(MusicThreatConfig.class);
    addClass(MusicThreatStatus.class);
    addClass(MusicThreatStatuses.class);
    ...
    addClass(PlayerSitOnFurnitureState.class);
    ...
    addClass(Basements.class);
    addClass(BasementsV1.class);
    ...
    addClass(AnimalPartsDefinitions.class);
    addClass(IsoAnimal.class);
    addClass(AnimalData.class);
    addClass(AnimalBreed.class);
    addClass(BaseAnimalBehavior.class);
    addClass(AnimalAllele.class);
    addClass(AnimalGene.class);
    addClass(AnimalGenomeDefinitions.class);
    addClass(AnimalDefinitions.class);
    addClass(IsoGameCharacter.Location.class);
    addClass(IsoGameCharacter.PerkInfo.class);
    addClass(IsoGameCharacter.XP.class);
    addClass(CharacterTraits.class);
    ...
    addClass(MoveDeltaModifiers.class);
    ...
    addClass(RuntimeAnimationScript.class);
    addClass(ColorInfo.class);
    addClass(Texture.class);
    addClass(VideoTexture.class);
    ...
    addClass(Colors.ColNfo.class);
    addClass(Colors.ColorSet.class);
    addClass(Core.class);
    ...
    addClass(LogSeverity.class);
    addClass(ObjectDebuggerLua.class);
    addClass(Component.class);
    addClass(ComponentType.class);
    addClass(EntityBucket.class);
    addClass(Family.class);
    addClass(GameEntity.class);
    addClass(GameEntityFactory.class);
    addClass(GameEntityType.class);
    addClass(MetaEntity.class);
    addClass(Attribute.class);
    addClass(AttributeContainer.class);
    addClass(AttributeInstance.class);
    addClass(AttributeInstance.Bool.class);
    addClass(AttributeInstance.String.class);
    addClass(AttributeInstance.Numeric.class);
    addClass(AttributeInstance.Float.class);
    addClass(AttributeInstance.Double.class);
    addClass(AttributeInstance.Byte.class);
    addClass(AttributeInstance.Short.class);
    addClass(AttributeInstance.Int.class);
    addClass(AttributeInstance.Long.class);
    addClass(AttributeInstance.Enum.class);
    addClass(AttributeInstance.EnumSet.class);
    addClass(AttributeInstance.EnumStringSet.class);
    addClass(AttributeType.class);
    addClass(AttributeType.Bool.class);
    addClass(AttributeType.String.class);
    addClass(AttributeType.Numeric.class);
    addClass(AttributeType.Float.class);
    addClass(AttributeType.Double.class);
    addClass(AttributeType.Byte.class);
    addClass(AttributeType.Short.class);
    addClass(AttributeType.Int.class);
    addClass(AttributeType.Long.class);
    addClass(AttributeType.Enum.class);
    addClass(AttributeType.EnumSet.class);
    addClass(AttributeType.EnumStringSet.class);
    addClass(AttributeValueType.class);
    addClass(AttributeUtil.class);
    addClass(EnumStringObj.class);
    addClass(CraftRecipeData.class);
    addClass(CraftRecipeData.CacheData.class);
    addClass(CraftRecipeData.InputScriptData.class);
    addClass(CraftRecipeData.OutputScriptData.class);
    addClass(CraftRecipeManager.class);
    addClass(CraftRecipeSort.class);
    addClass(HandcraftLogic.class);
    addClass(HandcraftLogic.CachedRecipeInfo.class);
    addClass(HandcraftLogic.InputItemNode.class);
    addClass(ItemDataList.class);
    addClass(OutputMapper.class);
    addClass(CraftBench.class);
    addClass(CraftLogic.class);
    addClass(FurnaceLogic.class);
    addClass(CraftMode.class);
    addClass(CraftRecipeMonitor.class);
    addClass(CraftUtil.class);
    addClass(FluidMatchMode.class);
    addClass(InputFlag.class);
    addClass(ItemApplyMode.class);
    addClass(MashingLogic.class);
    addClass(OutputFlag.class);
    addClass(StartMode.class);
    addClass(TimeMode.class);
    addClass(BaseCraftingLogic.class);
    addClass(BuildLogic.class);
    addClass(BaseCraftingLogic.CachedRecipeInfo.class);
    addClass(CraftRecipeComponent.class);
    addClass(CraftRecipeComponentScript.class);
    addClass(Fluid.class);
    addClass(FluidType.class);
    addClass(FluidCategory.class);
    addClass(FluidFilter.class);
    addClass(FluidFilter.FilterType.class);
    addClass(FluidConsume.class);
    addClass(FluidContainer.class);
    addClass(FluidProperties.class);
    addClass(FluidSample.class);
    addClass(FluidUtil.class);
    addClass(PoisonEffect.class);
    addClass(PoisonInfo.class);
    addClass(SealedFluidProperties.class);
    addClass(LuaComponent.class);
    addClass(Parts.class);
    addClass(Resource.class);
    addClass(ResourceBlueprint.class);
    addClass(ResourceChannel.class);
    addClass(ResourceEnergy.class);
    addClass(ResourceFlag.class);
    addClass(ResourceFluid.class);
    addClass(ResourceIO.class);
    addClass(ResourceItem.class);
    addClass(Resources.class);
    addClass(ResourceType.class);
    addClass(EntityScriptInfo.class);
    addClass(Signals.class);
    addClass(SpriteConfig.class);
    addClass(SpriteConfigManager.class);
    addClass(SpriteConfigManager.FaceInfo.class);
    addClass(SpriteConfigManager.ObjectInfo.class);
    addClass(SpriteConfigManager.TileInfo.class);
    addClass(TestComponent.class);
    addClass(UiConfig.class);
    addClass(Energy.class);
    addClass(EnergyType.class);
    addClass(ComponentEvent.class);
    addClass(ComponentEventType.class);
    addClass(EntityEvent.class);
    addClass(EntityEventType.class);
    addClass(MetaTagComponent.class);
    addClass(EntityDebugTest.class);
    addClass(EntityDebugTestType.class);
    addClass(AssocArray.class);
    addClass(AssocEnumArray.class);
    addClass(Array.class);
    addClass(BitSet.class);
    addClass(GameEntityUtil.class);
    addClass(ImmutableArray.class);
    ...
    addClass(SeamEditorState.class);
    addClass(SeamEditorState.BooleanDebugOption.class);
    addClass(SpriteModelEditorState.class);
    addClass(SpriteModelEditorState.BooleanDebugOption.class);
    addClass(TermsOfServiceState.class);
    addClass(TileGeometryState.class);
    addClass(TileGeometryState.BooleanDebugOption.class);
    ...
    addClass(RecipeMonitor.class);
    addClass(AnimalInventoryItem.class);
    ...
    addClass(ItemPickerJava.KeyNamer.class);
    addClass(ItemSpawner.class);
    ...
    addClass(IsoButcherHook.class);
    addClass(FBORenderTracerEffects.class);
    addClass(FBORenderChunk.class);
    ...
    addClass(IsoFeedingTrough.class);
    addClass(IsoHutch.class);
    addClass(IsoHutch.NestBox.class);
    ...
    addClass(RagdollSettingsManager.class);
    addClass(RagdollSettingsManager.RagdollSetting.class);
    addClass(RagdollSettingsManager.HitReactionSetting.class);
    addClass(RagdollSettingsManager.ForceHitReactionLocation.class);
    ...
    addClass(Trigger.class);
    addClass(VehicleZone.class);
    addClass(Zone.class);
    ...
    addClass(FishSchoolManager.class);
    addClass(WGUtils.class);
    addClass(WGParams.class);
    addClass(LuaEventManager.class);
    addClass(MapObjects.class);
    addClass(ActiveMods.class);
    addClass(PVPLogTool.class);
    addClass(PVPLogTool.PVPEvent.class);
    ...
    addClass(ServerOptions.EnumServerOption.class);
    addClass(ServerSettings.class);
    addClass(ServerSettingsManager.class);
    addClass(ContainerID.class);
    addClass(ContainerID.ContainerType.class);
    addClass(WarManager.class);
    addClass(WarManager.War.class);
    addClass(WarManager.State.class);
    ...
    addClass(GameEntityScript.class);
    addClass(GameEntityTemplate.class);
    addClass(ComponentScript.class);
    addClass(AttributesScript.class);
    addClass(CraftBenchScript.class);
    addClass(CraftLogicScript.class);
    addClass(CraftRecipe.class);
    addClass(CraftRecipe.RequiredSkill.class);
    addClass(InputScript.class);
    addClass(MashingLogicScript.class);
    addClass(FurnaceLogicScript.class);
    addClass(OutputScript.class);
    addClass(FluidContainerScript.class);
    addClass(FluidContainerScript.FluidScript.class);
    addClass(LuaComponentScript.class);
    addClass(PartsScript.class);
    addClass(SignalsScript.class);
    addClass(SpriteConfigScript.class);
    addClass(SpriteConfigScript.FaceScript.class);
    addClass(SpriteConfigScript.TileScript.class);
    addClass(SpriteConfigScript.XRow.class);
    addClass(SpriteConfigScript.ZLayer.class);
    addClass(TestComponentScript.class);
    addClass(UiConfigScript.class);
    addClass(ItemConfig.class);
    addClass(AnimationsMesh.class);
    addClass(BaseScriptObject.class);
    addClass(EnergyDefinitionScript.class);
    addClass(EvolvedRecipe.class);
    addClass(Fixing.class);
    addClass(Fixing.Fixer.class);
    addClass(Fixing.FixerSkill.class);
    addClass(FluidDefinitionScript.class);
    addClass(FluidFilterScript.class);
    addClass(GameSoundScript.class);
    addClass(Item.class);
    addClass(Item.Type.class);
    addClass(ItemRecipe.class);
    addClass(ItemFilterScript.class);
    addClass(MannequinScript.class);
    addClass(ModelAttachment.class);
    addClass(ModelScript.class);
    addClass(MovableRecipe.class);
    addClass(PhysicsShapeScript.class);
    ...
    addClass(SoundTimelineScript.class);
    addClass(StringListScript.class);
    addClass(TimedActionScript.class);
    addClass(UniqueRecipe.class);
    addClass(VehiclePartModel.class);
    ...
    addClass(VehicleTemplate.class);
    addClass(XuiColorsScript.class);
    addClass(XuiConfigScript.class);
    addClass(XuiLayoutScript.class);
    addClass(XuiSkinScript.class);
    addClass(VectorPosAlign.class);
    addClass(TextAlign.class);
    addClass(XuiAutoApply.class);
    addClass(XuiLuaStyle.class);
    addClass(XuiLuaStyle.XuiVar.class);
    addClass(XuiLuaStyle.XuiBoolean.class);
    addClass(XuiLuaStyle.XuiColor.class);
    addClass(XuiLuaStyle.XuiDouble.class);
    addClass(XuiLuaStyle.XuiFontType.class);
    addClass(XuiLuaStyle.XuiString.class);
    addClass(XuiLuaStyle.XuiStringList.class);
    addClass(XuiLuaStyle.XuiTexture.class);
    addClass(XuiLuaStyle.XuiTranslateString.class);
    addClass(XuiManager.class);
    addClass(XuiReference.class);
    addClass(XuiScript.class);
    addClass(XuiTableScript.class);
    addClass(XuiTableScript.XuiTableColumnScript.class);
    addClass(XuiTableScript.XuiTableRowScript.class);
    addClass(XuiTableScript.XuiTableCellScript.class);
    addClass(XuiScript.XuiVar.class);
    addClass(XuiScript.XuiBoolean.class);
    addClass(XuiScript.XuiColor.class);
    addClass(XuiScript.XuiDouble.class);
    addClass(XuiScript.XuiFloat.class);
    addClass(XuiScript.XuiFontType.class);
    addClass(XuiScript.XuiFunction.class);
    addClass(XuiScript.XuiInteger.class);
    addClass(XuiScript.XuiSpacing.class);
    addClass(XuiScript.XuiString.class);
    addClass(XuiScript.XuiStringList.class);
    addClass(XuiScript.XuiTexture.class);
    addClass(XuiScript.XuiTextAlign.class);
    addClass(XuiScript.XuiTranslateString.class);
    addClass(XuiScript.XuiUnit.class);
    addClass(XuiScript.XuiVector.class);
    addClass(XuiScript.XuiVectorPosAlign.class);
    addClass(XuiScriptType.class);
    addClass(XuiSkin.class);
    addClass(XuiSkin.EntityUiStyle.class);
    addClass(XuiSkin.ComponentUiStyle.class);
    addClass(XuiVarType.class);
    addClass(ScriptManager.class);
    addClass(ScriptType.class);
    addClass(SeamManager.class);
    addClass(SeatingManager.class);
    addClass(SpriteModelManager.class);
    addClass(TemplateText.class);
    addClass(ReplaceProviderCharacter.class);
    addClass(TileDepthTexture.class);
    addClass(TileDepthTextureAssignmentManager.class);
    addClass(TileDepthTextureManager.class);
    addClass(TileDepthTextures.class);
    addClass(TileGeometryManager.class);
    addClass(TilesetDepthTexture.class);
    ...
    addClass(AtomUI.class);
    addClass(AtomUIText.class);
    addClass(AtomUITexture.class);
    addClass(AtomUITextEntry.class);
    addClass(AtomUIMap.class);
    ...
    addClass(PZUnmodifiableList.class);
    ...
    addClass(VehicleEngineRPM.class);
    ...
    addClass(DesignationZoneAnimal.class);
    addClass(AnimalTracks.class);
    addClass(IsoAnimalTrack.class);
    addClass(AnimalChunk.class);
    addClass(VirtualAnimal.class);
    addClass(DesignationZone.class);
    ...
    addClass(RBGunstoreSiege.class);
    addClass(RBPoliceSiege.class);
    addClass(RBHeatBreakAfternoon.class);
    addClass(RBTrashed.class);
    addClass(RBBarn.class);
    addClass(RBDorm.class);
    addClass(RBNolans.class);
    addClass(RBJackieJaye.class);
    addClass(RBReverend.class);
    addClass(RBTwiggy.class);
    addClass(RBWoodcraft.class);
    addClass(RBJoanHartford.class);
    addClass(RBJudge.class);
    addClass(RBMayorWestPoint.class);
    ...
    addClass(RDSDevouredByRats.class);
    addClass(RDSRPGNight.class);
    addClass(RDSRatInfested.class);
    addClass(RDSRatKing.class);
    addClass(RDSRatWar.class);
    addClass(RDSResourceGarage.class);
    addClass(RDSGrouchos.class);
    ...
    addClass(RVSCarCrashDeer.class);
    addClass(RVSDeadEnd.class);
    addClass(RVSRegionalProfessionVehicle.class);
    addClass(RVSRoadKill.class);
    addClass(RVSRoadKillSmall.class);
    addClass(RVSAnimalOnRoad.class);
    addClass(RVSHerdOnRoad.class);
    addClass(RVSAnimalTrailerOnRoad.class);
    addClass(RVSRichJerk.class);
    addClass(RVSPlonkies.class);
    ...
    addClass(RZSBurntWreck.class);
    addClass(RZSHermitCamp.class);
    addClass(RZSHillbillyHoedown.class);
    addClass(RZSHogWild.class);
    addClass(RZSRockerParty.class);
    addClass(RZSSadCamp.class);
    addClass(RZSSurvivalistCamp.class);
    addClass(RZSVanCamp.class);
    addClass(RZSEscapedAnimal.class);
    addClass(RZSEscapedHerd.class);
    addClass(RZSAttachedAnimal.class);
    addClass(RZSOrphanedFawn.class);
    addClass(RZSNastyMattress.class);
    addClass(RZSWasteDump.class);
    addClass(RZSMurderScene.class);
    addClass(RZSTragicPicnic.class);
    addClass(RZSRangerSmith.class);
    addClass(RZSOccultActivity.class);
    addClass(RZSWaterPump.class);
    addClass(RZSOldFirepit.class);
    addClass(RZSOldShelter.class);
    addClass(RZSCampsite.class);
    addClass(RZSCharcoalBurner.class);
    addClass(RZSDean.class);
    addClass(RZSDuke.class);
    addClass(RZSFrankHemingway.class);
    addClass(RZSKirstyKormick.class);
    addClass(RZSSirTwiggy.class);
    addClass(RZJackieJaye.class);
